...
-- XIRR bisection, STAGE 3 of 4 (halvings 11-15 of 20; staged materialisation).
-- Continues the bracket from the physical stage-2 table. See int_fund_xirr_s05.sql for
