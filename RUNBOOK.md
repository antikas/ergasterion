...
python -m pip install "ergasterion-factory[duckdb]==0.3.0"
```
...
```bash
python -m pip install "ergasterion-factory[snowflake]==0.3.0"
python -m pip install "ergasterion-factory[bigquery]==0.3.0"
python -m pip install "ergasterion-factory[all]==0.3.0"
```
